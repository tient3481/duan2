...
${pageContext.request.contextPath}/api/employee/salary/get/${accountId}">Danh
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fas fa-table"> Cập nhật loại nghỉ phép</i>
					</div>
					<div class="card-body">
						<!-- Grid row -->
						<form action="${pageContext.request.contextPath}/api/leave_type">
							<c:forEach var="listLeaveTypeGetOne"
								items="${listLeaveTypeGetOne}">
								<div class="form-row">
									<!-- Grid column -->
									<div class="col-md-12">
										<!-- Material input -->
										<div class="md-form form-group">
											<div class="form-group">
												<label><b>Tên loại nghỉ phép</b></label>
