...
${pageContext.request.contextPath}/api/employee/salary/get/${accountId}">Danh
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fas fa-table"> Add Employee Relationships</i>
					</div>
					<div class="card-body">
						<!-- Grid row -->
						<div class="form-row">
							...
							<div class="col-md-6">
								...
								<div class="md-form form-group">
									<label><b style="color: #ff0000;">Họ và tên bố/ mẹ</b></label>
									<div class="form-group">
										<div class="form-label-group">
											<input type="text" class="form-control" id="1"
												placeholder="Họ và tên"> <label for="1">Ví
												dụ: Nguyễn Văn A</label>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="form-group">
										...
										<div class="form-label-group">
											<input type="text" class="form-control" id="2"
												placeholder="Nghề nghiệp"> <label for="2">Ví
												dụ: Giáo viên</label>
										</div>
									</div>
								</div>
							...
							<div class="col-md-3">
								...
								<div class="md-form form-group">
									<div class="form-group">
										<label><b style="color: #ff0000;">Số điện thoại</b></label>
										<div class="form-label-group">
											<input type="text" class="form-control" id="3"
												placeholder="Số điện thoại"> <label for="3">Ví
							...
							<div class="col-md-12">
								...
								<div class="md-form form-group">
									<div class="form-group">
										<label><b style="color: #ff0000;">Địa chỉ</b></label>
										<div class="form-label-group">
											<input type="text" class="form-control" id="4"
												placeholder="Địa chỉ"> <label for="4">Ví dụ:
												Số nhà 01, đường ABC, Thành Phố XYZ</label>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-12">
								...
								<div class="md-form form-group">
									<div class="form-group">
										<label><b>Địa chỉ khác</b></label>
										<div class="form-label-group">
											<input type="text" class="form-control" id="9"
												placeholder="Địa chỉ"> <label for="9">Ví dụ:
												Số nhà 01, đường ABC, Thành Phố XYZ</label>
										</div>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-md-6">
								<!-- Material input -->
								<div class="md-form form-group">
									<label><b style="color: #ff0000;">Họ và tên anh/
											chị/ em</b></label>
									<div class="form-group">
										<div class="form-label-group">
											<input type="text" class="form-control" id="5"
												placeholder="Họ và tên"> <label for="5">Ví
												dụ: Nguyễn Thị B</label>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="form-group">
										...
										<div class="form-label-group">
											<input type="text" class="form-control" id="6"
												placeholder="Nghề nghiệp"> <label for="6">Ví
												dụ: Giáo viên</label>
										</div>
									</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="form-label-group">
											<input type="text" class="form-control" id="7"
												placeholder="Số điện thoại"> <label for="7">Ví
												dụ: +84987654321</label>
										</div>
									</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="form-label-group">
											<input type="text" class="form-control" id="8"
												placeholder="Địa chỉ"> <label for="8">Ví dụ:
												Số nhà 01, đường ABC, Thành Phố XYZ</label>
										</div>
									</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="form-label-group">
											<input type="text" class="form-control" id="10"
												placeholder="Địa chỉ"> <label for="10">Ví
												dụ: Số nhà 01, đường ABC, Thành Phố XYZ</label>
										</div>
									</div>
								</div>
							</div>
