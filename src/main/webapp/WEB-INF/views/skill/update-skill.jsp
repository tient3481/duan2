		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						<!-- Grid row -->
						<form action="${pageContext.request.contextPath}/api/skill">
							<c:forEach var="listSkillGetOne" items="${listSkillGetOne}">
								<div class="form-row">
									<!-- Grid column -->
									<div class="col-md-12">
										<!-- Material input -->
										<div class="md-form form-group">
											<div class="form-group">
												<label><b>Nhóm kỹ năng</b></label>
												<div class="form-label-group">
													<select class="form-control" id="exampleFormControlSelect1"
														name="category_id">

														<option value="${listSkillGetOne.getCategory_id()}">${listSkillGetOne.getCategoryName()}</option>
