...
${pageContext.request.contextPath}/api/login">Danh
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fas fa-table"> Add New Category Skill</i>
					</div>
					<div class="card-body">
						<!-- Grid row -->
						<div class="form-row">
							...
							<div class="col-md-12">
								...
								<div class="md-form form-group">
									<label><b style="color: #ff0000;">Tên nhóm kỹ năng</b></label>
									<div class="form-group">
										<div class="form-label-group">
											<input type="text" class="form-control" id="1"
												placeholder="Tên kỹ năng"> <label for="1">Ví
												dụ: Java, C, C++,...</label>
										</div>
									</div>
								</div>
							...
							<div class="col">
								...
								<div class="md-form form-group">
									<div class="form-group">
										<label><b style="color: #ff0000;">Mô tả nhóm kỹ năng</b></label>
										<div class="form-label-group">
											<textarea class="form-control" rows="10" id="2"
												placeholder="Ví dụ: Lập trình các ứng dụng theo yêu cầu của dự án trên nền web"></textarea>
										</div>
									</div>
								</div>
							</div>
