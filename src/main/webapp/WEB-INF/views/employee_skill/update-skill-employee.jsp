...
${pageContext.request.contextPath}/api/employee/salary/get/${accountId}">Danh
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fas fa-table"> Cập nhật kỹ năng nhân viên</i>
					</div>
					...
					<form
						...
						<div class="card-body">
							...
							<div class="form-row">
										...
										<div class="form-group">
											...
											<div class="form-label-group">
												<input type="number" class="form-control" id="6"
													value="${skillStart}" name="skill_start"> <label
													for="6">SkillStart</label>
											</div>
										</div>
									</div>
								</div>
										...
										<div class="form-group">
											...
											<div class="form-label-group">
												<input type="number" class="form-control" id="7"
													value="${skillEnd}" name="skill_end"> <label
													for="6">SkillEnd</label>
											</div>
										</div>
									</div>
								</div>
								...
								<div>
									<button type="submit" name="updateEmployeeSkill"
