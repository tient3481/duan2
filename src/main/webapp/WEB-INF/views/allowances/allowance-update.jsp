...
${pageContext.request.contextPath}/api/employee/salary/get/${accountId}">Danh
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fas fa-table"> Thêm mới khoản trợ cấp</i> <a
					...
					<div class="card-body">
						<!-- Grid row -->
						<form
							action="${pageContext.request.contextPath}/api/employee/allownce">
							<div class="form-row">
								<!-- Grid column -->
								<div class="col-md-12">
									<!-- Material input -->
									<div class="md-form form-group">
										<div class="form-group">
											<label><b>Loại trợ cấp</b></label> <select
												class="browser-default custom-select" name="saTypeId">
												<c:forEach items="${listAllowance}" var="listAllowance">
													<option value="${listAllowance.getSaId()}">${listAllowance.getSatName()}</option>
												</c:forEach>
											</select>
										</div>
									</div>
								...
								<div class="col-md-12">
									<!-- Material input -->
									<div class="md-form form-group">
										<label><b>Số tiền hỗ trợ</b></label>
										<div class="form-group">
											<div class="form-label-group">
												<input type="text" class="form-control" id="2"
													name="saTotalSalary" required="required"
													placeholder="Total money"> <label for="2">
												</label>
											</div>
										</div>
									</div>
							...
							<button type="submit" name="updateAllowance"
