			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						<!-- Grid row -->
						<form
							action="${pageContext.request.contextPath}/api/employee/allowance">
							<div class="form-row">
								<!-- Grid column -->
								<div class="col-md-12">
									<!-- Material input -->
									<div class="md-form form-group">
										<div class="form-group">
											<label><b>Loại trợ cấp</b></label> <select
												...
												name="salary_allowance_type_id">
												<c:forEach items="${listAllowance}" var="listAllowance">
													<option value="${listAllowance.getSatId()}">${listAllowance.getSatName()}</option>
												</c:forEach>
											</select>
										</div>
									</div>
										...
										<div class="form-group">
											<div class="form-label-group">
												<input type="text" class="form-control" id="2"
													name="total_salary" required="required"
													placeholder="Số tiền hỗ trợ"> <label for="2">
												</label>
											</div>
										</div>
									</div>
							...
							<button type="submit" name="addAllowance"
