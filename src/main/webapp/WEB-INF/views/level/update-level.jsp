...
${pageContext.request.contextPath}/api/login">Danh
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fas fa-table"> Cập nhật thông tin trình độ</i>
					</div>
						...
						<div class="card-body">
							...
							<div class="form-row">
								...
								<div class="col-md-12">
									...
									<c:forEach var="list" items="${listLevelInfo}">
											...
											<div class="form-group">
												<div class="form-label-group">
													<input type="text" class="form-control" id="1" name="name"
														...
														placeholder="Department name"> <label for="1">Level
														name</label>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="form-label-group">
													<input type="text" class="form-control" id="2" name="note"
														value="${list.getNote()}" required="required"> <label
														for="2">Note</label>
												</div>
											</div>

											<div>
												<button type="submit" name="updateLevel"
