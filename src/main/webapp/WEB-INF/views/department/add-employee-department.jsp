...
${pageContext.request.contextPath}/api/login">Danh
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fas fa-table"> Add Employee Department</i>
					</div>
					<form
						action="${pageContext.request.contextPath}/api/employee/department">
						<div class="card-body">
							<!-- Grid row -->
							<div class="form-row">
								<!-- Grid column -->
								<div class="col-md-7">
									...
									<div class="md-form form-group">
										<div class="form-group">
											<label><b>Chọn nhân viên</b></label>
											<div class="form-label-group">
												<select class="form-control" id="exampleFormControlSelect1"
													name="employee_id" disabled="disabled">
													<c:forEach items="${listEmpNameAndId}" var="list">
								...
								<div class="col-md-5">
									<!-- Material input -->
									<div class="md-form form-group">
										<label><b>Chọn loại nhân viên</b></label>
										<div class="form-group">
											<div class="form-label-group">
												<select class="form-control" id="exampleFormControlSelect1"
													name="employee_type_id">
													<c:forEach items="${listEmployeeType}" var="list">
									...
									<div class="md-form form-group">
										...
										<div class="form-group">
											<div class="form-label-group">
												<select class="form-control" id="exampleFormControlSelect1"
													name="department_id">
													<c:forEach items="${listDepNameAndId}" var="list">
														<option value="${list.getId()}">${list.getName()}</option>
													</c:forEach>
												</select>
											</div>
								...
								<div class="col-md-12">
									<!-- Material input -->
									<div class="md-form form-group">
										<label><b>Chọn chức vụ</b></label>
										<div class="form-group">
											<div class="form-label-group">
												<select class="form-control" id="exampleFormControlSelect1"
													name="position_id">
													<c:forEach items="${listPosNameAndId}" var="list">
														<option value="${list.getId()}">${list.getName()}</option>
													</c:forEach>
												</select>
											</div>
							...
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<button type="submit" name="addEmployeeDepartment"
