...
${pageContext.request.contextPath}/api/login">Danh
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fas fa-table"> Add New Department</i>
					</div>
					<form action="${pageContext.request.contextPath}/api/department">
						<div class="card-body">
							...
							<div class="form-row">
										...
										<div class="form-group">
											<div class="form-label-group">
												<input type="text" class="form-control" id="1" name="name"
													required="required" placeholder="Họ và tên"> <label
													for="1">Ví dụ: Nguyễn Văn A</label>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col">
									...
									<div class="md-form form-group">
										<div class="form-group">
											<label><b>Số điện thoại phòng ban</b></label>
											<div class="form-label-group">
												<input type="text" class="form-control" id="2" name="phone"
													required="required" placeholder="Số điện thoại"> <label
													for="2">Ví dụ: +84987654321</label>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-md-12">
									...
									<div class="md-form form-group">
										<div class="form-group">
											<label><b>Địa chỉ phòng ban</b></label>
											<div class="form-label-group">
												<input type="text" class="form-control" id="3"
													name="location" required="required" placeholder="Địa chỉ">
												<label for="3">Ví dụ: Số nhà 01, đường ABC, Thành
													Phố XYZ</label>
											</div>
										</div>
									</div>
						...
						<div>
							<button type="submit" name="addDepartment"
								style="margin-left: 50%;" class="btn btn-primary">Save</button>
						</div>
