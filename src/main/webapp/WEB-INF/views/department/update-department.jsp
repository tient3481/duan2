...
${pageContext.request.contextPath}/api/login">Danh
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fas fa-table"> Cập nhật thông tin phòng ban</i>
					</div>
						...
						<div class="card-body">
							...
							<div class="form-row">
								...
								<div class="col-md-8">
									...
									<c:forEach var="list" items="${listDepartmentInfo}">
											...
											<div class="form-group">
												<div class="form-label-group">
													<input type="text" class="form-control" id="1" name="name"
														...
														placeholder="Department name"> <label for="1">Department
														name</label>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="form-label-group">
													<input type="text" class="form-control" id="2" name="phone"
														...
														placeholder="Department phone"> <label for="2">Department
														phone</label>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="form-label-group">
													<input type="text" class="form-control" id="3"
														...
														value="${list.getLocation()}"> <label for="3">Department
														Location</label>
												</div>
											</div>
											<div>
												<button type="submit" name="updateDepartment"
													style="margin-left: 50%;" class="btn btn-primary">Update</button>
											</div>
