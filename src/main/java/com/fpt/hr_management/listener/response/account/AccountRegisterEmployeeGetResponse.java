...
public class AccountRegisterEmployeeGetResponse {
	private int employeeId;
	private String employeeName;

	public AccountRegisterEmployeeGetResponse() {

	}

	public AccountRegisterEmployeeGetResponse(int employeeId, String employeeName) {
		super();
