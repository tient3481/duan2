...
public class LeaveTypeListGetOneResponse extends BaseEntity {
	private int id;
	private String name;
	private String note;

	public LeaveTypeListGetOneResponse() {
		super();
	}

	public LeaveTypeListGetOneResponse(int id, String name, String note, String created_date, String created_by,
	...
	public String toString() {
		...
		builder.append("LeaveTypeListGetOneResponse [id=").append(id).append(", name=").append(name).append(", note=")
