...
public class LeaveEmployeeGetOneResponse {
	...
	public LeaveEmployeeGetOneResponse(int id, int employee_id, String employeeName, int reason_id, String reasonName,
			Date start_date, Date end_date, Time start_time, Time end_time, Timestamp created_time,
			String employee_accept, Timestamp accept_time, int accept_status, String note) {
		super();
		this.id = id;
