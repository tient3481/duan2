...
public class AccountAddRequest extends BaseRequest {
	...
	public AccountAddRequest(int role_id, int employee_id, String username, String password) {
		super();
	...
	public AccountAddRequest(int role_id, int employee_id, String username, String password, String created_by,
	...
	public AccountAddRequest(int id, int role_id, int employee_id, String username, String password, String created_by,
			String last_modifier_by) {
		super();
		this.id = id;
		this.role_id = role_id;
