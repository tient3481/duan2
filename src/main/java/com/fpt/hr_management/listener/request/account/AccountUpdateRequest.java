...
public class AccountUpdateRequest extends BaseRequest {
	...
	public AccountUpdateRequest(int role_id, int employee_id, String username, String password) {
		super();
	...
	public AccountUpdateRequest(int role_id, int employee_id, String username, String password, String created_by,
	...
	public AccountUpdateRequest(int id, int role_id, int employee_id, String username, String password,
