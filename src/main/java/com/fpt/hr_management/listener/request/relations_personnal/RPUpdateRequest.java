...
public class RPUpdateRequest {
	...
	public RPUpdateRequest() {
		super();
	}

	public RPUpdateRequest(int id, int employee_id, String dad_name, String mother_name, String dad_job,
			String mother_job, String dad_phone, String mother_phone, String address, String address_more,
			String bs_name, String bs_phone, String bs_address, String description) {
		super();
		this.id = id;
	...
	public String toString() {
		...
		builder.append("RPUpdateRequest [id=").append(id).append(", employee_id=").append(employee_id)
				.append(", dad_name=").append(dad_name).append(", mother_name=").append(mother_name)
				.append(", dad_job=").append(dad_job).append(", mother_job=").append(mother_job).append(", dad_phone=")
				.append(dad_phone).append(", mother_phone=").append(mother_phone).append(", address=").append(address)
